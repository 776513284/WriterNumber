...
import com.huangsuhai.writernumber.R;

/**
 * Created by HuangSuhai on 2018/1/22.
 */
...
public class mCustomProgressDialog extends ProgressDialog {  //自定义对话框类头部
    ...
    public mCustomProgressDialog(Context context, String content, int id) {
        ...
        //设置单击周边是否让dialog消失 设置为true点击周边消失
        setCanceledOnTouchOutside(true);
    }  //自定义对话框构造方法尾部

    @Override
    protected void onCreate(Bundle savedInstanceState) {  //创建的onCreate方法头部
